...
public class EmailUtil {
    ...
    public static void sendEmail(String reportPath) {
        String senderEmail = new ConfigReader().getSMTPSenderEmail();
        String recipientEmail = new ConfigReader().getSMTPRecipientEmail();
        String smtpPassword = new ConfigReader().getSMTPPassword();
        String host = "smtp.gmail.com";  // Example SMTP host
        String port = "587";             // Example SMTP port
        ...
        try {
            ...
            // Create the message part for text and the file attachment
